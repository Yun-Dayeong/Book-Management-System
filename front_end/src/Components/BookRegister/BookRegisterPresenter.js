...
const BookRegisterPresenter = (props) => {
    return (
        <div className="flex justify-center items-center mt-16">
            <div>
                <div className="font-sans text-xl text-center font-bold text-black mx-8 my-4">Book Register</div>
                <input
                ...
                <img className="bg-gray-200 w-40 h-56 border border-gray-200 mt-1" src={props.imageViewURL} alt=""></img><br />
                ...
                <div className="mt-3">
                    <button
                        ...
                        onClick={props.bookRegister}>책 등록하기</button>
                    <button
